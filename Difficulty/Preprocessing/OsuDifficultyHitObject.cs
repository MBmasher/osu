...
namespace osu.Game.Rulesets.Osu.Difficulty.Preprocessing
{
    public class OsuDifficultyHitObject : DifficultyHitObject
    {
        ...
        private void setCombo(OsuHitObject current, OsuHitObject previous, OsuHitObject previous2)
        {
            current.CumulativeCombo = 0;
            if (previous2 == null)
            {
                previous.CumulativeCombo = getCombo(previous);
            }
            current.CumulativeCombo += previous.CumulativeCombo + getCombo(current);
        }
