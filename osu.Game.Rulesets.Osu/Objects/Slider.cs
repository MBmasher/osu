...
namespace osu.Game.Rulesets.Osu.Objects
{
    public class Slider : OsuHitObject, IHasCurve
    {
        ...
        /// <summary>
        /// Amount of <see cref="SliderTick"/>s in this <see cref="Slider"/>.
        /// </summary>
        public double TickCount { get; private set; }

        /// <summary>
        /// Amount of combo that this <see cref="Slider"/> can give.
        /// </summary>
        public double ComboWorth {get; private set; }
        ...
        protected override void ApplyDefaultsToSelf(ControlPointInfo controlPointInfo, BeatmapDifficulty difficulty)
        {
            ...
            TickCount = Math.Floor(Distance / TickDistance);
            ComboWorth = 2 + RepeatCount + TickCount * (RepeatCount + 1);
        }
